    ...
    <?php require_once "../header.php"; ?>
        ...
        <div class="lyric">   
            <p>
                ...
                What you need<br>
                Mm<br>
                But now I have finally seen the end (finally seen the end)<br>
                And I'm not expecting you to care (expecting you to care)<br>
                That I have finally seen the light (finally seen the light)<br>
                ...
                Yes I know, I can be wrong<br>
                And maybe I'm too headstrong<br>
                Our love is<br>
                Madness<br>
            </p>
        </div> 
